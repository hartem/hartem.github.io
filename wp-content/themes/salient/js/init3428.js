...
/*-------------------------------------------------------------------------*/	
	...
	function postNextButtonEffect(){
		...
		$('.blog_next_prev_buttons').imagesLoaded(function(){
			...
			var nextButtonImage = $('.blog_next_prev_buttons img');
			if (typeof(nextButtonImage) != "undefined")
			{	
				nextButtonImage.css('opacity','1');

				if (typeof(nextButtonImage.panr) != "undefined")
				{
					nextButtonImage.panr({
						scaleDuration: .28,
						sensitivity: 22,
						scaleTo: 1.06
					});
